...
function Promotion() {
     return (
          <section className="bg-primary-light px-12 py-24 max-xxs:px-0">
               <div className="grid grid-cols-2 max-md:grid-rows-2 max-md:grid-cols-1 max-xxs:grid-rows-[2fr_1fr]">
                    <div className="space-y-12 mb-16 max-xxs:px-12">
                         ...
                         <div className="w-2/3 space-y-6 max-md:w-full">
                              <h3 className="text-4xl uppercase font-light">
                                   Your skin deserves the best care.
                              </h3>
                              <p className="text-sm">
                                   Discover a curated collection of skincare
                                   products designed to rejuvenate , protect,
                                   and pamper your skin. Explore our range
                                   crafted with love backed by science, and
                                   inspired by nature.
                              </p>
                         </div>
                    ...
                    <div className="relative flex">
                         <img
                              src="/photo-4.png"
                              alt="Product"
                              className="w-full h-full rounded-2xl z-10 object-cover absolute max-xxs:rounded-none"
                         />
                         <div className="absolute h-full w-full z-20 rounded-2xl flex items-end justify-center">
                              <div className="grid grid-cols-[auto_1fr] bg-primary rounded-full w-3/5 mb-6 px-2 py-1">
                                   <svg
                                        width="50"
                                        height="50"
                                        viewBox="0 0 50 50"
                                        ...
                                        className="size-18 rounded-full outline-2 outline-dotted outline-offset-3 bg-font-primary"
                                   >
                                        <path
