function Footer() {
     return (
          <footer className="bg-font-primary text-font-footer relative">
               <div className="grid grid-rows-[auto_auto] px-12">
                    ...
                    <div className="flex justify-between items-center pt-6 max-sm:flex-col max-sm:gap-y-4">
                         ...
                         <ul className="flex items-center gap-x-6 text-sm max-sm:w-full max-sm:justify-between">
               ...
               <div className="h-[20rem] overflow-hidden flex justify-center -my-16 max-lg:h-[15rem] max-md:h-[10rem] max-xs:h-[8rem] max-xs:-my-6">
                    <h2 className="text-font-secondary text-[21rem] font-extrabold max-xl:text-[18rem] max-lg:text-[15rem] max-md:text-[10rem] max-xs:text-[7.5rem]">
                         SKINCARE
                    </h2>
               </div>
          </footer>
